...
class SparseFeaturePyramid(nn.Module):
    ...
    def forward(self, feats):        
        ...
        # Top to down aggregation&interpolation (Downsample Aggregation)
        last_layer_feat = outs_1[-1].features
        last_layer_bcoord = outs_1[-1].indices  #TOP
        ...
        feat_new = torch_scatter.scatter_mean(fused_feat, inv, dim=0) # intergrate
        ...
        outs_2.append(residual) #(Down -> Top)
        ...
        for i in range(1, self.num_encoder_levels):
            ...
            outs_d2t.append(out_dict) #(Down -> Top)
